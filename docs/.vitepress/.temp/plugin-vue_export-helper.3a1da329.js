...
function renderComponentRoot$1(instance) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode$1(render2.length > 1 ? render2(props, process.env.NODE_ENV !== "production" ? {
        get attrs() {
          markAttrsAccessed();
          return attrs;
        },
      ...
      case Text:
        if (domType !== 3) {
          ...
          if (node.data !== vnode.children) {
            hasMismatch = true;
            process.env.NODE_ENV !== "production" && warn$1(`Hydration text mismatch:
    ...
    if (process.env.NODE_ENV !== "production" || forcePatchValue || patchFlag !== -1) {
      ...
      if (shapeFlag & 16 && !(props && (props.innerHTML || props.textContent))) {
        ...
        if (el.textContent !== vnode.children) {
          hasMismatch = true;
          process.env.NODE_ENV !== "production" && warn$1(`Hydration text content mismatch in <${vnode.type}>:
...
function endMeasure(instance, type) {
  if (instance.appContext.config.performance && isSupported()) {
    ...
    perf.mark(endTag);
    perf.measure(`<${formatComponentName$1(instance, instance.type)}> ${type}`, startTag, endTag);
...
const normalizeRef = ({ ref: ref2, ref_key, ref_for }) => {
  return ref2 != null ? isString(ref2) || isRef$1(ref2) || isFunction(ref2) ? { i: currentRenderingInstance, r: ref2, k: ref_key, f: !!ref_for } : ref2 : null;
};
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    setCurrentInstance(instance);
    pauseTracking();
    const setupResult = callWithErrorHandling$1(setup, instance, 0, [process.env.NODE_ENV !== "production" ? shallowReadonly(instance.props) : instance.props, setupContext]);
    resetTracking();
    unsetCurrentInstance();
